...
THREE.Volume = function( xLength, yLength, zLength, type, arrayBuffer ) {
	 ...
	 *                      If changed,NeedsUpdate is automatically set to true on all the slices associated to this volume
	 */
	 ...
	 *  If changed, AM AL SI2 ACO FC CIUNeedsUpdate is automatically set to true on all the slices associated to this volume
	 */
...
THREE.Volume.prototype = {
	...
	/**
	 * @member {Function} extractPerpendicularPlane Compute the orientation of the slice and returns all the information relative to the AM AL SI2 ACO FC CIU such as sliceAccess, the plane matrix (orientation and position in RAS coordinate) and the dimensions of the plane in both coordinate system.
	 * @memberof THREE.Volume
	 * @param {string}            axis  the normal axis to the slice 'x' 'y' or 'z'
	 * @param {number}            index the index of the slice
	 * @returns {Object} an object containing all the usefull information on the AM AL SI2 ACO FC CIU of the slice
	 */
